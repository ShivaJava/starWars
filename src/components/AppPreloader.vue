<template>
  <span class="AppPreloader">
      <span class="AppPreloader__indicator">
          <svg class="AppPreloader__image" viewBox="0 0 60 65" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect v-for="(light, index) in imageLights"
                  v-bind:key="index"
                  class="AppPreloader__image-light" 
                  :width="light.width" 
                  height="2" 
...
export default {           
    ...
    data() {
        return {
            imageLights: [
                {width: 13.6257, transform: 'matrix(-1 3.17865e-08 3.17865e-08 1 36.605 55.1332)', },
                {width: 11.1925, transform: 'matrix(-1 3.17865e-08 3.17865e-08 1 35.6316 59.0262)', },
                {width: 8.75936, transform: 'matrix(-1 3.17865e-08 3.17865e-08 1 34.1719 62.9193)', }
            ],
            opacity: ['1', '0.4', '0.1'],
            opacityIndex: 0,
        }
